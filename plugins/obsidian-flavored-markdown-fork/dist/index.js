...
var mermaid_inline_default = 'var k=Object.defineProperty;var M=(n,t,r)=>t in n?k(n,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):n[t]=r;var s=(n,t,r)=>M(n,typeof t!="symbol"?t+"":t,r);function b(n,t){if(!n)return;function r(i){i.target===this&&(i.preventDefault(),i.stopPropagation(),t())}function o(i){i.key.startsWith("Esc")&&(i.preventDefault(),t())}n?.addEventListener("click",r),window.addCleanup(()=>n?.removeEventListener("click",r)),document.addEventListener("keydown",o),window.addCleanup(()=>document.removeEventListener("keydown",o))}function x(n){for(;n.firstChild;)n.removeChild(n.firstChild)}var g=class{constructor(t,r){s(this,"container",t);s(this,"content",r);s(this,"isDragging",!1);s(this,"startPan",{x:0,y:0});s(this,"currentPan",{x:0,y:0});s(this,"scale",1);s(this,"MIN_SCALE",.5);s(this,"MAX_SCALE",3);s(this,"cleanups",[]);this.setupEventListeners(),this.setupNavigationControls(),this.resetTransform()}setupEventListeners(){let t=this.onMouseDown.bind(this),r=this.onMouseMove.bind(this),o=this.onMouseUp.bind(this),i=this.onTouchStart.bind(this),l=this.onTouchMove.bind(this),e=this.onTouchEnd.bind(this),a=this.resetTransform.bind(this);this.container.addEventListener("mousedown",t),document.addEventListener("mousemove",r),document.addEventListener("mouseup",o),this.container.addEventListener("touchstart",i,{passive:!1}),document.addEventListener("touchmove",l,{passive:!1}),document.addEventListener("touchend",e),window.addEventListener("resize",a),this.cleanups.push(()=>this.container.removeEventListener("mousedown",t),()=>document.removeEventListener("mousemove",r),()=>document.removeEventListener("mouseup",o),()=>this.container.removeEventListener("touchstart",i),()=>document.removeEventListener("touchmove",l),()=>document.removeEventListener("touchend",e),()=>window.removeEventListener("resize",a))}cleanup(){for(let t of this.cleanups)t()}setupNavigationControls(){let t=document.createElement("div");t.className="mermaid-controls";let r=this.createButton("+",()=>this.zoom(.1)),o=this.createButton("-",()=>this.zoom(-.1)),i=this.createButton("Reset",()=>this.resetTransform());t.appendChild(o),t.appendChild(i),t.appendChild(r),this.container.appendChild(t)}createButton(t,r){let o=document.createElement("button");return o.textContent=t,o.className="mermaid-control-button",o.addEventListener("click",r),window.addCleanup(()=>o.removeEventListener("click",r)),o}onMouseDown(t){t.button===0&&(this.isDragging=!0,this.startPan={x:t.clientX-this.currentPan.x,y:t.clientY-this.currentPan.y},this.container.style.cursor="grabbing")}onMouseMove(t){this.isDragging&&(t.preventDefault(),this.currentPan={x:t.clientX-this.startPan.x,y:t.clientY-this.startPan.y},this.updateTransform())}onMouseUp(){this.isDragging=!1,this.container.style.cursor="grab"}onTouchStart(t){if(t.touches.length!==1)return;this.isDragging=!0;let r=t.touches[0];this.startPan={x:r.clientX-this.currentPan.x,y:r.clientY-this.currentPan.y}}onTouchMove(t){if(!this.isDragging||t.touches.length!==1)return;t.preventDefault();let r=t.touches[0];this.currentPan={x:r.clientX-this.startPan.x,y:r.clientY-this.startPan.y},this.updateTransform()}onTouchEnd(){this.isDragging=!1}zoom(t){let r=Math.min(Math.max(this.scale+t,this.MIN_SCALE),this.MAX_SCALE),o=this.content.getBoundingClientRect(),i=o.width/2,l=o.height/2,e=r-this.scale;this.currentPan.x-=i*e,this.currentPan.y-=l*e,this.scale=r,this.updateTransform()}updateTransform(){this.content.style.transform=`translate(${this.currentPan.x}px, ${this.currentPan.y}px) scale(${this.scale})`}resetTransform(){let r=this.content.querySelector("svg").getBoundingClientRect(),o=r.width/this.scale,i=r.height/this.scale;this.scale=1,this.currentPan={x:(this.container.clientWidth-o)/2,y:(this.container.clientHeight-i)/2},this.updateTransform()}},B=["--secondary","--tertiary","--gray","--light","--lightgray","--highlight","--dark","--darkgray","--bodyFont","--codeFont","--mm-bg","--mm-node-bg","--mm-node-border","--mm-text","--mm-line","--mm-cluster-bg","--mm-cluster-border","--mm-note-bg","--mm-note-border","--mm-actor-bg","--mm-actor-border","--mm-active-bg","--mm-active-border","--mm-edge-label-bg","--mm-fill-0","--mm-fill-1","--mm-fill-2","--mm-fill-3","--mm-fill-4","--mm-fill-5","--mm-fill-6","--mm-fill-7","--mm-error-bg","--mm-error-text"],w=`\n  /* Node shapes \\u2014 strip user fills, restore organic palette */\n  .node > rect,\n  .node > polygon,\n  .node > circle,\n  .node > ellipse,\n  .node > path,\n  .node .basic.label-container {\n    fill: var(--mm-node-bg) !important;\n    stroke: var(--mm-node-border) !important;\n    stroke-width: 1.5px !important;\n  }\n\n  /* Subgraph clusters \\u2014 softer dashed border */\n  .cluster > rect,\n  .cluster > polygon,\n  .cluster > path {\n    fill: var(--mm-cluster-bg) !important;\n    stroke: var(--mm-cluster-border) !important;\n    stroke-width: 1.5px !important;\n    stroke-dasharray: 4 3 !important;\n  }\n\n  /* Notes (flowchart + sequence + class diagrams) */\n  g.note > rect,\n  g.note > polygon,\n  rect.note,\n  .note {\n    fill: var(--mm-note-bg) !important;\n    stroke: var(--mm-note-border) !important;\n  }\n\n  /* Sequence diagram actors */\n  rect.actor,\n  .actor {\n    fill: var(--mm-actor-bg) !important;\n    stroke: var(--mm-actor-border) !important;\n  }\n  line.actor-line { stroke: var(--mm-line) !important; }\n  .activation0, .activation1, .activation2 {\n    fill: var(--mm-active-bg) !important;\n    stroke: var(--mm-active-border) !important;\n  }\n\n  /* All text \\u2014 force readable contrast on the unified palette */\n  text,\n  .nodeLabel,\n  .edgeLabel,\n  .label,\n  .messageText,\n  .actor-text,\n  .actor > tspan,\n  .loopText,\n  .loopText > tspan,\n  .labelText,\n  .labelText > tspan,\n  .cluster .nodeLabel,\n  .cluster-label .nodeLabel,\n  span.nodeLabel,\n  foreignObject div,\n  foreignObject span,\n  foreignObject p {\n    color: var(--mm-text) !important;\n    fill: var(--mm-text) !important;\n  }\n\n  /* Edge labels \\u2014 pill-like background that matches page paper */\n  .edgeLabel {\n    background-color: var(--mm-edge-label-bg) !important;\n  }\n  .edgeLabel rect,\n  .edgeLabel foreignObject {\n    fill: var(--mm-edge-label-bg) !important;\n  }\n\n  /* Edge / link paths and arrowheads */\n  .edgePath > path.path,\n  .edgePath path,\n  .flowchart-link,\n  path.relation {\n    stroke: var(--mm-line) !important;\n    fill: none !important;\n  }\n  marker path,\n  .edgePath marker path,\n  .marker {\n    fill: var(--mm-line) !important;\n    stroke: var(--mm-line) !important;\n  }\n\n  /* Pie chart slices keep mermaid\'s themeVariables (pie1..12), but enforce\n     readable label color */\n  .pieTitleText, .slice, .legend text { fill: var(--mm-text) !important; }\n`,S=/(?:^|[\\s;{])\\s*(?:fill|stroke|color|background-color|background)\\s*:\\s*[^;}]+;?/gi;function P(n){n.querySelectorAll("style:not([data-organic-override])").forEach(r=>{let o=r.textContent||"";if(!o)return;let i=o.replace(S,l=>/^[\\s;{]/.test(l)?l[0]:"");i!==o&&(r.textContent=i)})}function H(n){let t=[".node rect",".node polygon",".node circle",".node ellipse",".node path",".cluster rect",".cluster polygon",".cluster path","g.note rect","g.note polygon","rect.note","rect.actor",".actor","line.actor-line",".activation0",".activation1",".activation2"].join(",");n.querySelectorAll(t).forEach(r=>{r.removeAttribute("fill"),r.removeAttribute("stroke"),r.style.removeProperty("fill"),r.style.removeProperty("stroke")}),n.querySelectorAll("text, tspan, .nodeLabel, .label, .messageText, .actor-text, .loopText, .labelText, foreignObject div, foreignObject span, foreignObject p").forEach(r=>{r.removeAttribute("fill"),r.style?.removeProperty?.("fill"),r.style?.removeProperty?.("color")})}function A(n){let t=n.querySelector("svg");if(!t)return;P(t),H(t);let r=t.querySelector("style[data-organic-override]");r&&r.remove();let o=document.createElementNS("http://www.w3.org/2000/svg","style");o.setAttribute("data-organic-override","true"),o.textContent=w,t.appendChild(o)}var y;async function L(){let t=document.querySelector(".center").querySelectorAll("code.mermaid");if(t.length===0)return;y||(y=await import("https://cdnjs.cloudflare.com/ajax/libs/mermaid/11.4.0/mermaid.esm.min.mjs"));let r=y.default,o=new WeakMap;for(let l of t)o.set(l,l.innerText);async function i(){for(let a of t){a.removeAttribute("data-processed");let m=o.get(a);m&&(a.innerHTML=m)}let e=B.reduce((a,m)=>(a[m]=window.getComputedStyle(document.documentElement).getPropertyValue(m),a),{});r.initialize({startOnLoad:!1,securityLevel:"loose",theme:"base",flowchart:{curve:"basis",htmlLabels:!0,useMaxWidth:!0},sequence:{useMaxWidth:!0,mirrorActors:!1},themeVariables:{fontFamily:e["--bodyFont"]||e["--codeFont"],fontSize:"14px",background:e["--mm-bg"],mainBkg:e["--mm-node-bg"],secondBkg:e["--mm-fill-1"],tertiaryColor:e["--mm-fill-2"],primaryColor:e["--mm-node-bg"],primaryTextColor:e["--mm-text"],primaryBorderColor:e["--mm-node-border"],secondaryColor:e["--mm-fill-1"],secondaryTextColor:e["--mm-text"],secondaryBorderColor:e["--mm-note-border"],tertiaryTextColor:e["--mm-text"],tertiaryBorderColor:e["--mm-cluster-border"],lineColor:e["--mm-line"],textColor:e["--mm-text"],titleColor:e["--mm-text"],edgeLabelBackground:e["--mm-edge-label-bg"],labelTextColor:e["--mm-text"],clusterBkg:e["--mm-cluster-bg"],clusterBorder:e["--mm-cluster-border"],noteBkgColor:e["--mm-note-bg"],noteBorderColor:e["--mm-note-border"],noteTextColor:e["--mm-text"],actorBkg:e["--mm-actor-bg"],actorBorder:e["--mm-actor-border"],actorTextColor:e["--mm-text"],actorLineColor:e["--mm-line"],signalColor:e["--mm-text"],signalTextColor:e["--mm-text"],labelBoxBkgColor:e["--mm-fill-1"],labelBoxBorderColor:e["--mm-note-border"],loopTextColor:e["--mm-text"],activationBkgColor:e["--mm-active-bg"],activationBorderColor:e["--mm-active-border"],sequenceNumberColor:e["--mm-bg"],sectionBkgColor:e["--mm-fill-0"],altSectionBkgColor:e["--mm-fill-2"],sectionBkgColor2:e["--mm-fill-3"],gridColor:e["--mm-cluster-border"],taskBkgColor:e["--mm-actor-bg"],taskBorderColor:e["--mm-actor-border"],taskTextColor:e["--mm-text"],taskTextLightColor:e["--mm-bg"],taskTextOutsideColor:e["--mm-text"],taskTextDarkColor:e["--mm-text"],activeTaskBkgColor:e["--mm-active-bg"],activeTaskBorderColor:e["--mm-active-border"],doneTaskBkgColor:e["--mm-cluster-bg"],doneTaskBorderColor:e["--mm-cluster-border"],critBkgColor:e["--mm-error-bg"],critBorderColor:e["--mm-error-text"],todayLineColor:e["--tertiary"],labelColor:e["--mm-text"],errorBkgColor:e["--mm-error-bg"],errorTextColor:e["--mm-error-text"],fillType0:e["--mm-fill-0"],fillType1:e["--mm-fill-1"],fillType2:e["--mm-fill-2"],fillType3:e["--mm-fill-3"],fillType4:e["--mm-fill-4"],fillType5:e["--mm-fill-5"],fillType6:e["--mm-fill-6"],fillType7:e["--mm-fill-7"],pie1:e["--secondary"],pie2:e["--tertiary"],pie3:e["--mm-fill-3"],pie4:e["--mm-fill-5"],pie5:e["--mm-fill-6"],pie6:e["--mm-fill-4"],pie7:e["--mm-fill-7"],pie8:e["--mm-fill-0"],pie9:e["--mm-fill-1"],pie10:e["--mm-fill-2"],pie11:e["--gray"],pie12:e["--darkgray"],pieTitleTextColor:e["--mm-text"],pieSectionTextColor:e["--mm-text"],pieLegendTextColor:e["--mm-text"],pieStrokeColor:e["--mm-bg"],pieOuterStrokeColor:e["--mm-line"],git0:e["--secondary"],git1:e["--tertiary"],git2:e["--mm-fill-5"],git3:e["--mm-fill-6"],git4:e["--mm-fill-3"],git5:e["--mm-fill-4"],git6:e["--mm-fill-7"],git7:e["--gray"],gitBranchLabel0:e["--mm-bg"],gitBranchLabel1:e["--mm-bg"],gitBranchLabel2:e["--mm-text"],gitBranchLabel3:e["--mm-text"],gitBranchLabel4:e["--mm-text"],gitBranchLabel5:e["--mm-text"],gitBranchLabel6:e["--mm-text"],gitBranchLabel7:e["--mm-text"],commitLabelColor:e["--mm-text"],commitLabelBackground:e["--mm-edge-label-bg"],tagLabelColor:e["--mm-text"],tagLabelBackground:e["--mm-fill-1"],tagLabelBorder:e["--mm-note-border"]}}),await r.run({nodes:t});for(let a of t)A(a)}await i(),document.addEventListener("themechange",i),window.addCleanup(()=>document.removeEventListener("themechange",i));for(let l=0;l<t.length;l++){let f=function(){let v=c.querySelector("#mermaid-space"),p=c.querySelector(".mermaid-content");if(!p)return;x(p);let T=e.querySelector("svg").cloneNode(!0);p.appendChild(T),c.classList.add("active"),v.style.cursor="grab",u=new g(v,p)},E=function(){c.classList.remove("active"),u?.cleanup(),u=null},e=t[l],a=e.parentElement,m=a.querySelector(".clipboard-button"),d=a.querySelector(".expand-button"),h=window.getComputedStyle(m),C=m.offsetWidth+parseFloat(h.marginLeft||"0")+parseFloat(h.marginRight||"0");d.style.right=`calc(${C}px + 0.3rem)`,a.prepend(d);let c=a.querySelector("#mermaid-container");if(!c)return;let u=null;d.addEventListener("click",f),b(c,E),window.addCleanup(()=>{u?.cleanup(),d.removeEventListener("click",f)})}}document.addEventListener("nav",L);document.addEventListener("render",L);\n';
