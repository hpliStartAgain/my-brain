...
export default ((userOpts?: Partial<Options>) => {
  const ArticleCarousel: QuartzComponent = ({
    allFiles,
    fileData,
    displayClass,
    cfg,
    ...
    const allArticles = pages.map((page) => {
      ...
      return {
        ...
        date: date ? date.toLocaleDateString(cfg.locale, { year: "numeric", month: "short", day: "numeric" }) : "",
      }
    })
    ...
    return (
      <div
        ...
        data-show-count={opts.showCount}
      >
  ...
  ArticleCarousel.css = style
  ArticleCarousel.afterDOMLoaded = `
