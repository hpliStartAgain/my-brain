...
date: 2026-03-04
tags: [Connector, MPP, Presto, SQL, Trino, 中间件, 查询优化, 联邦查询]
aliases: []
---
...
- SQL 基础和数据仓库概念
- 建议了解 [[大数据/Hive/00 专栏导览|Hive]]/[[大数据/Iceberg/00 专栏导览|Iceberg]] 等数据湖格式（Trino 最常用的数据源）

---

## 关联专栏

- [[大数据/Hive/00 专栏导览|Hive]]：TrHive Connector 是最常用的数据源
- [[大数据/Iceberg/00 专栏导览|Iceberg]]：Iceberg Connector 支持时间旅行查询
- [[中间件/Doris/00 专栏导览|Doris]]、[[中间件/Clickhouse/00 专栏导览|ClickHouse]]：联邦查询 vs 单一 OLAP 引擎的选型
- [[Java/JVM/00 专栏导览|JVM]]：Trino 是 Java 应用，JVM 内存管理与 GC 调优影响查询性能
