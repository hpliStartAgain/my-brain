...
date: 2026-03-03
tags: [ISR, Kafka, KRaft, Rebalance, 中间件, 分布式, 日志存储, 消息队列]
aliases: []
---
...
| **02** | [[02 日志存储引擎——Segment、索引与零拷贝]] | Partition 的 Segment 文件（.log/.index/.timeindex）、稀疏索引的二分查找、顺序写磁盘、sendfile 零拷贝、[[Linux/内存管理/00 专栏导览|Page Cache]] 的利用 |
...
| **06** | [[06 Controller 与集群管理——从 ZooKeeper 到 KRaft]] | Controller 的选举与职责、元数据管理、KRaft 模式（Kafka Raft）的架构变化、去 [[中间件/Zookeeper/00 专栏导览|ZooKeeper]] 的动机与迁移 |
