...
date: 2026-03-03
tags: [AOP, Bean生命周期, IoC, Java, Spring, 事务管理, 依赖注入]
aliases: []
---
...
- Java 基础、反射与动态代理
- 建议先阅读 [[Java/OOP设计模式/00 专栏导览|OOP 设计模式]] 专栏了解工厂模式、代理模式、观察者模式、模板方法模式

---

## 关联专栏

- [[Java/SpringBoot/00 专栏导览|Spring Boot]]：基于 Spring Core 的自动配置、Starter 机制
- [[Java/OOP设计模式/00 专栏导览|OOP 设计模式]]：Spring 大量使用工厂、代理、观察者、模板方法等模式
- [[Java/Mybatis/00 专栏导览|MyBatis]]：MyBatis-Spring 整合依赖 Spring IoC 容器
- [[中间件/Dubbo/00 专栏导览|Dubbo]]：Dubbo 深度整合 Spring 的 Bean 生命周期和扩展点
