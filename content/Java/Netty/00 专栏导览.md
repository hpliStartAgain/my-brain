...
- Java 基础、IO 流的基本使用
- 建议先阅读 [[Java/并发编程/00 专栏导览|Java 并发编程]] 专栏了解 CAS、线程池和 [[Java/JVM/00 专栏导览|JVM]] 专栏了解堆外内存
...
- [[Linux/网络协议栈与IO/00 专栏导览|Linux 网络协议栈]]：epoll 是 Netty NioEventLoop 的底层实现
- [[Java/并发编程/00 专栏导览|Java 并发编程]]：Netty 广泛使用 CAS、线程池、Future 等并发原语
- [[Java/JVM/00 专栏导览|JVM]]：堆外内存（DirectByteBuffer）与 GC 的交互
- [[Java/OOP设计模式/00 专栏导览|OOP 设计模式]]：Pipeline 责任链、Reactor 模式、享元模式
- [[中间件/Dubbo/00 专栏导览|Dubbo]]：Dubbo 的网络层基于 Netty 实现
- [[中间件/Elasticsearch/00 专栏导览|Elasticsearch]]：ES 的传输层基于 Netty
