...
- **[[Hadoop YARN 调度]]**：Tez 任务在 YARN 上运行，理解 YARN 的资源调度是理解 Tez 性能的前提
- **[[Spark SQL 深度解析与性能调优]]**：Hive 与 Spark SQL 的 Catalyst 优化器设计高度相似（Hive 是 Catalyst 的思想来源），对比阅读价值极高
- **[[HiveServer2 Kerberos 认证故障报告]]**：第 11 篇的生产案例参考
- **[[HiveServer2 Redis UDF 文件描述符泄漏故障报告]]**：第 09、12 篇的生产案例参考
