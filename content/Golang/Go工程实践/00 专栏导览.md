...
title: "Go 工程实践 专栏导览"
date: 2026-03-04
tags: [Golang, Module, 工程实践, 性能优化, 测试, 错误处理, 项目结构]
aliases: []
---
...
- Go 基础语法和标准库的基本使用
- 建议先阅读 [[Golang/Go语言核心/00 专栏导览|Go 语言核心]] 和 [[Golang/Go并发编程/00 专栏导览|Go 并发编程]] 专栏

---

## 关联专栏

- [[Golang/Go语言核心/00 专栏导览|Go 语言核心]]、[[Golang/Go并发编程/00 专栏导览|Go 并发编程]]：本专栏的前置知识
- [[Linux/性能优化/00 专栏导览|性能优化专栏]]：Go pprof/trace 与 Linux perf/bpf 的配合使用
- [[可观测/Profiler/00 专栏导览|Profiler 专栏]]：持续性能剖析与火焰图分析
