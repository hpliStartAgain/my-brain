...
- [[大数据/Flink/Flink从入门到实战/00 专栏导览|Flink]]：Paimon 与 Flink 深度集成，是官方推荐的计算引擎
- [[中间件/Leveldb/00 专栏导览|LevelDB]]：Paimon 基于 LSM-Tree 存储模型
- [[大数据/数据湖/Iceberg/00 专栏导览|Iceberg]]、[[大数据/数据湖/Delta-Lake-Lakehouse架构深度解析/00 专栏导览|Delta Lake]]、[[大数据/数据湖/Hudi/00 专栏导览|Hudi]]：数据湖表格式对比
- [[中间件/Kafka/00 专栏导览|Kafka]]：Paimon 可替代 Kafka 做实时中间层
