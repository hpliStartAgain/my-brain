...
date: 2026-03-02
tags: [CDC, Hudi, Lakehouse, 专栏导览, 增量处理, 数据湖]
aliases: []
---
...
- [[大数据/Spark/Spark-SQL深度解析与性能调优/00 专栏导览|Spark SQL]]：Hudi 常用 Spark 作为计算引擎
- [[大数据/Flink/Flink从入门到实战/00 专栏导览|Flink]]：Flink CDC 写入 Hudi
- [[中间件/Kafka/00 专栏导览|Kafka]]：Kafka 作为 Hudi 的 CDC 数据源
- [[大数据/数据湖/Iceberg/00 专栏导览|Iceberg]]、[[大数据/数据湖/Delta-Lake-Lakehouse架构深度解析/00 专栏导览|Delta Lake]]、[[大数据/数据湖/paimon/00 专栏导览|Paimon]]：数据湖表格式对比
