...
- [[大数据/Spark/Spark-RDD核心原理解析/00 专栏导览|Spark RDD]]：RDD 宽窄依赖决定 Stage 切分
- [[大数据/Spark/Spark-Shuffle与内存管理机制深度解析/00 专栏导览|Spark Shuffle 与内存管理]]：Shuffle 是 Stage 边界的核心机制
- [[大数据/Hadoop/Yarn/00 专栏导览|YARN]]：Spark on YARN 的资源申请与 Executor 管理
- [[大数据/Spark/Spark-on-Kubernetes工程实践/00 专栏导览|Spark on K8s]]：K8s 部署模式下的调度差异
