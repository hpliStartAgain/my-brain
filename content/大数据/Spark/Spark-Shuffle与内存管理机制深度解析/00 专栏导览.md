...
date: 2026-02-27
tags: [RSS, Shuffle, Spark, UnifiedMemoryManager, 内存管理]
aliases: []
---
...
阅读本专栏前，建议先了解：
- [[大数据/Spark/Spark-RDD核心原理解析/00 专栏导览|Spark RDD 核心原理]] — 理解 RDD 算子语义与宽依赖/窄依赖
- [[大数据/Spark/Spark-调度系统与执行模型深度解析/00 专栏导览|Spark 调度系统与执行模型]] — 理解 Stage 切分与 Task 执行机制
- [[Java/JVM/00 专栏导览|JVM 内存模型]] — 理解堆内/堆外内存、GC 基本原理

---

## 关联专栏

- [[大数据/Spark/Spark-RDD核心原理解析/00 专栏导览|Spark RDD]]：Shuffle 由宽依赖触发
- [[大数据/Spark/Spark-调度系统与执行模型深度解析/00 专栏导览|Spark 调度系统]]：Shuffle 是 Stage 边界的核心机制
- [[大数据/Spark/Spark-容错与状态管理深度解析/00 专栏导览|Spark 容错与状态管理]]：姊妹专栏，FetchFailedException 触发 Stage 重试
- [[Java/JVM/00 专栏导览|JVM]]：Tungsten 堆外内存与 JVM GC 的关系
- [[Linux/内存管理/00 专栏导览|内存管理]]：Spark Executor 的内存使用与 OS 内存管理
