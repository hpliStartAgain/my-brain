...
- [[云原生/Kubernetes/kubernetes之API Server/00 专栏导览|API Server]]：Informer/Watch 是控制器的核心依赖
- [[云原生/Kubernetes/kubernetes架构原则和对象设计/00 专栏导览|K8s 架构]]：控制器模式、工作负载对象
- [[Golang/Go工程实践/00 专栏导览|Go 工程实践]]：Kubebuilder/controller-runtime 基于 Go 生态
- [[Java/OOP设计模式/00 专栏导览|OOP 设计模式]]：控制器模式对应观察者模式和状态机模式
