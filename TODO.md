...
- [x] 第二档 6/8：Zookeeper（6 篇）——篇均 12028 字 / 614 行，6 张 dracula Mermaid，30 链接零死链（2026-09-26 完成）；顺带修掉 `00 专栏导览` 里 9 处既有死链并同步目录描述
- [ ] 第二档 7/8：Trino（6 篇）
- [ ] 第二档 8/8：ETCD（6 篇）
...
| Zookeeper | 6 | 12028 | 614 | 6 张 dracula | 0 / 30 |
| **合计** | **54** | **12045** | — | **77 张** | **0 / 339** |

第一档 5/5 与第二档首个专栏已完成，累计 54 篇正文、650489 中文字。
